...
MUST EDIT THE PATH OF CHROMEDRIVER IN ORDER TO COMPILE ON A DIFFERENT MACHINE
"""
...
def GetSheetInfo():
    row = input("Enter the corresponding row number in 'Questionaire (Responses)': ")
    return row
...
if __name__ == '__main__':
    ...
    creds = ServiceAccountCredentials.from_json_keyfile_name(
        r"C:\Users\Administrator\Desktop\Visa_Application\client_secret.json", scope)
    ...
    driver = webdriver.Chrome(executable_path=r"C:\Users\Administrator/Desktop/Visa_Application\Drivers\chromedriver.exe",chrome_options=options) #path the chromedriver
