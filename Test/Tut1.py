...
if __name__ == '__main__':
    ...
    options.binary_location = r'C:\Program Files (x86)\Google\Chrome Beta\Application\chrome.exe' #path to Chrome
    driver = webdriver.Chrome(executable_path=r"C:\Users\Kingsley\Dropbox\Kingsley\Project\Scraper\Drivers\chromedriver.exe",chrome_options=options) #path the chromedriver
